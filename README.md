...
Tailored specifically for low-frequency gravitational wave observatories like LISA, LAB is built on top of **JAX** to ensure lightning-fast, JIT-compiled computations. It seamlessly integrates with `astropy.cosmology` for rigorous background cosmology calculations and with `lisaanalysistools` to ensure homogenized usage of constants.
