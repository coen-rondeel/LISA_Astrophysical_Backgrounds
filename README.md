...
Tailored specifically for low-frequency gravitational wave observatories like LISA, LAB is built on top of **JAX** to ensure fast, parallelizable, JIT-compiled computations. It seamlessly integrates with `astropy.cosmology` for rigorous background cosmology calculations and with `lisaconstants` to ensure homogenized usage of constants.
